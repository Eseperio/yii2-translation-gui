...
class Language
{
     ...
     *      ],
     * ];
     * $result = \eseperio\translatemanager\helpers\Language::a($array, $params);
     * ~~~
     *
     * The result:
     *
    ...
    {
        return Yii::$app->session->has(\eseperio\translatemanager\Module::SESSION_KEY_ENABLE_TRANSLATE);
    }
